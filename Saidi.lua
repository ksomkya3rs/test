...
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم استرجاع المجموعات من نسخه صعيدي')
else
...
--download('https://raw.githubusercontent.com/somkya3rs/test/master/Saidi.lua','Saidi.lua')
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').."احظرو عام" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." حظر عام" or text == 'حظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء حظر عام" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء الحظر عام" or text == "الغاء حظر عام" or text == 'الغاء الحظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(2)..' 〙* ',"md",true)  
end
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." اكتمو عام" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." كتم عام" or text == ('كتم عام') and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء الكتم العام" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').."الغاء كتم العام" or text == 'الغاء كتم العام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." احظرو" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').."حظر" or text == 'حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء الحظر" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء حظر" or text == 'الغاء حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." اكتمو" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." كتم" or text == 'كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء الكتم" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء كتم" or text == 'الغاء كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." تقيد" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." تقييد" or text == 'تقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').."الغاء التقيد" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." الغاء التقييد" or text == 'الغاء التقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." اطرد ده" or text == (Redis:get(Saidi.."Name:Bot") or 'صعيدي').." طرد" or text == 'طرد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local Jabwa_ns = 'ʜᴇʀᴇ ᴀʀᴇ ʏᴏᴜʀ ᴘʜᴏᴛᴏѕ'
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
{text = '𓄼• اخفاء الامر •𓄹', callback_data = msg.sender.user_id..'/Jabwa88'}, 
},
{
...
keyboard.inline_keyboard = {
{
{text = '• غنيلي • ', callback_data = IdUser..'/Sinyly@'},{text = '• غنيلي تامر حسني •', callback_data = IdUser..'/Sinyly2@'},
},
{
{text = '• غنيلي عمرو دياب •', callback_data = IdUser..'/Sinyly3@'},{text = '• غنيلي تامر عاشور •', callback_data = IdUser..'/Sinyly4@'},
},
{
{text = '• غنيلي محمد فؤاد •', callback_data = IdUser..'/Sinyly5@'},{text = '• غنيلي حماقي •', callback_data = IdUser..'/Sinyly6@'},
},
{
{text = '• غنيلي ابو الانوار •', callback_data = IdUser..'/Sinyly7@'},{text = '• غنيلي رامي صبري •', callback_data = IdUser..'/Sinyly8@'},
},
{
{text = '• غنيلي مسلم •', callback_data = IdUser..'/Sinyly9@'},{text = '• غنيلي ويجز •', callback_data = IdUser..'/Sinyly10@'},
},
{
{text = '• غنيلي عمار حسني •', callback_data = IdUser..'/Sinyly11@'},{text = '• غنيلي عنبه •', callback_data = IdUser..'/Sinyly12@'},
},
{
{text = '• غنيلي مهرجانات  •', callback_data = IdUser..'/Sinyly13@'},{text = '• غنيلي اصاله •', callback_data = IdUser..'/Sinyly14@'},
},
{
{text = '• غنيلي اليسا  •', callback_data = IdUser..'/Sinyly15@'},{text = '• غنيلي كايروكي •', callback_data = IdUser..'/Sinyly16@'},
},
{
...
zh = https.request('https://apiSaidi.ml/zrf.php?Saidi='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n* ✧ قائمه الزخرفه ⇧⇩*\n*⩹┉┉┉┉⊶❲𖥳 ??𝐀𝐈𝐃𝐈 𖥳❳⊷┉┉┉┉⩺*\n* أضغط علي الاسم لا يتم النسخ ✧ *\n"
i = 0
for k,v in pairs(zx.ok) do
...
gk = https.request('https://apiSaidi.ml/brg.php?brg='..URL.escape(text)..'')
br = JSON.decode(gk)
i = 0
...
if text == (Redis:get(Saidi.."Name:Bot") or "صعيدي") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local Jabwa = LuaTele.getUser(Saidi)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• تويت اخرا •𓄹', data = msg.sender.user_id..'/Haiw1'}, },}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• كتبات اخرا •𓄹', data = msg.sender.user_id..'/Haiw2'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• نكته اخرا •𓄹', data = msg.sender.user_id..'/Haiw3'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• اذكار اخرا •𓄹', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• لو خيروك اخرا •𓄹', data = msg.sender.user_id..'/Haiw4'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
end
...
data = {
{
{text = '〘 مـطـور الـسـورس 〙',type = 'text'},
},
{
...
Redis:srem(Saidi..'Jabwa:In:Tuasl',Info_User)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• تويت اخرا •𓄹', data = IdUser..'/Haiw1'}, },}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• كتبات اخرا •𓄹', data = IdUser..'/Haiw2'}, },}}
LuaTele.editMessageText(ChatId,Msg_id,texting[math.random(#texting)], 'md', true, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• نوكته اخرا •𓄹', data = IdUser..'/Haiw3'}, },}}
LuaTele.editMessageText(ChatId,Msg_id,texting[math.random(#texting)], 'md', true, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𓄼• لو خيروك اخرا •𓄹', data = IdUser..'/Haiw4'}, },}}
LuaTele.editMessageText(ChatId,Msg_id,texting[math.random(#texting)], 'md', true, false, reply_markup)
end
end
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly@'},
},
{
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly2@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly3@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly4@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly5@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly6@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly7@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly8@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly9@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly10@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly11@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly12@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly13@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly14@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly15@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly16@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly17@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
keyboard.inline_keyboard = {
{
{text = '𓄼• مره اخرى •𓄹', callback_data = IdUser..'/Sinyly18@'},
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', callback_data = IdUser..'/Back@'},
},
...
data = {
{
{text = '𓄼• العاب التسليه •𓄹', data = IdUser..'/normgm'}, 
},
{
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس صعيدي اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
