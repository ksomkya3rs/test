...
io.write('\27[1;31mابعت يا عسليه توكن البوت يلا \nSend Me a Bot Token Now ↡\n\27[0;39;49m')
local TokenBot = io.read()
if TokenBot and TokenBot:match('(%d+):(.*)') then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getMe')
local Json_Info = JSON.decode(url)
if res ~= 200 then
print('\27[1;34mالتوكن غلط ياض يا عسليه \nBot Token is Wrong\n')
else
io.write('\27[1;34mتم حفظ التوكن يا عسليه \nThe token been saved successfully \n\27[0;39;49m')
...
print('\27[1;34mلم يتم حفظ التوكن ياض يا عسليه جرب تاني \nToken not saved, try again')
end 
os.execute('lua Saidi.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31mابعت يا عسليه يوزر المطور الاساسي \nDeveloper UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34mحفظت اليوزر يا عسليه \nDeveloper UserName saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34mلم يتم حفظ اليوزر يا عسليه جرب تاني \nDeveloper UserName not saved\n')
end 
os.execute('lua Saidi.lua')
end
if not Redis:get(SshId.."Info:Redis:User:ID") then
io.write('\27[1;31mابعت ايدي المطور الاساسي يا عسليه \nDeveloper ID saved ↡\n\27[0;39;49m')
local UserId = io.read()
if UserId and UserId:match('(%d+)') then
io.write('\n\27[1;34mتم حفظ الايدي يا عسليه \nDeveloper ID saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User:ID",UserId)
else
print('\n\27[1;34mلم يتم حفظ الايدي ياض يا عسليه جرب تاني \nDeveloper ID not saved\n')
end 
os.execute('lua Saidi.lua')
end
...
LuaTele = luatele.set_config{api_id=8008944,api_hash='7712b5a5e1769e4dc9729c55fe804f65',session_name=Saidi,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,5105436521,1825532106,1124610301}  
...
if tonumber(msg.sender.user_id) == 5105436521 then
...
elseif Redis:sismember(Saidi.."HELPBEVQ:Groups",msg.sender.user_id) == true then
...
local N = (Redis:get(Saidi.."Name:Bot") or "فايكينج")
...
{
{text = '𓄼• 𝘴ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ •𓄹', url='https://t.me/V_I_K_I_N_G_1'},
},
}
}
...
--download('https://raw.githubusercontent.com/kmesgdknlksrf/imback/master/Saidi.lua','Saidi.lua')
...
NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "فايكينج")
...
keyboard.inline_keyboard = {
{
{text =first_name, url = "https://t.me/V_I_K_I_N_G_1"}
},
{
{text = selva, url = 't.me/V_I_K_I_N_G_1'}, 
},
{
{text = Grosupsw, url = 't.me/V_I_K_I_N_G_1'}, 
},
{
{text = Usperos, url = 't.me/V_I_K_I_N_G_1'}, 
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
if not Redis:sismember(Saidi.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."HELPBEVQ:Groups")
Redis:del(Saidi.."HELPBEVQ:Groups", bana.id)
Redis:del(Saidi.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(Saidi.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."HELPBEVQ:Groups")
Redis:del(Saidi.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(Saidi.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(Saidi.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."HELPBEVQ:Groups")
Redis:del(Saidi.."HELPBEVQ:Groups", UserId)
Redis:del(Saidi.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(Saidi.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."HELPBEVQ:Groups")
Redis:sadd(Saidi.."HELPBEVQ:Groups", UserId)
Redis:set(Saidi.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(Saidi.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."HELPBEVQ:Groups")
Redis:sadd(Saidi.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(Saidi.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(Saidi.."HELPBEVQ:Groups",UserId) then
...
Redis:sadd(Saidi.."Saidi:allM"..msg.chat_id, msg.id)
if Redis:get(Saidi.."Saidi:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Saidi.."Saidi:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Saidi.."Saidi:allM"..msg.chat_id)
...
LuaTele.sendText(msg_chat_id,msg_id, t)
Redis:del(Saidi.."Saidi:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Saidi.."Saidi:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = " ⌯ تم مسح "..k.." من الوسائط الموجوده"
...
local gmria = Redis:scard(Saidi.."Saidi:allM"..msg.chat_id)  
 LuaTele.sendText(msg_chat_id,msg_id,"⌯ عدد الميديا الموجود هو〘* "..gmria.." *〙","md")
end
if text == "تعطيل المسح التلقائي" then        
if not msg.TheBasics then
...
Redis:del(Saidi.."Saidi:Status:Del:Media"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تعطيل المسح التلقائي للميديا')
return false
end 
if text == "تفعيل المسح التلقائي" then        
...
Redis:set(Saidi.."Saidi:Status:Del:Media"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تفعيل المسح التلقائي للميديا')
return false
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع كت "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
...
if ban.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @V_I_K_I_N_G_1"..Creator.."\n"
else
...
data = {
{
{text = '𓄼• 𝘴ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ •𓄹', url = 't.me/V_I_K_I_N_G_1'}, 
},
}
}
...
{
{text = '᥇ ꪮ𝓽   ꪜ𝓲𝘬𝓲 ꪀ ᧁ',url="t.me/AsaliyaEgypt_bot"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المبرمج سيزر' or text == 'سيزر' or text == '4235463453345345' or text == '𓄼 المبرمج سيزر 𓄹' then    
...
if text == 'م2424242ور 42' or text == '242424242242' or text == '2424242 24' or text == '𓄼 5454545 54545 𓄹' then    
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if text == 'السورس' or text == 'يا سورس' or text == 'سورس ' or text == 'سورسي' then
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
video = "http://t.me/V_I_K_I_N_G_2/107"
local T =[[
╔•ـــــــــــــــــــــــــــــــــــــــــ

[⚙️╠ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝗜𝗞𝗜𝗡𝗚](http://t.me/V_I_K_I_N_G_1)

╠•ـــــــــــــــــــــــــــــــــــــــــ

[🌐╠ 𝗧𝗛𝗘 𝗕𝗘𝗦𝗧 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠](http://t.me/V_I_K_I_N_G_1)

╠•ـــــــــــــــــــــــــــــــــــــــــ

[🎊╠ 𝗙𝗢𝗟𝗟𝗢𝗪 𝗧𝗛𝗘 𝗕𝗨𝗧𝗧𝗢𝗡𝗦  𝗕𝗘𝗟𝗟𝗢𝗪](http://t.me/V_I_K_I_N_G_1)
...
{
{text = '𓄼•�𝙻3𝚂𝙺���•𓄹', url = "https://t.me/Ahmeaaa11"},{text = '𓄼•𝚂𝙴𝚉𝚁•𓄹', url = "https://t.me/ttccss"}
},
{
{text = '𓄼•𝙰𝚂𝙰𝙻𝙸𝚈𝙰 𝙴𝙶𝚈𝙿𝚃•𓄹', url = "https://t.me/AsaliyaEgypt"}
},
...
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
photo = "https://t.me/V_I_K_I_N_G_2/141"
...
{
{text = '𓄼•ʙᴏᴛ•𓄹', url = "https://t.me/hazf_Saidi_bot"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
local first_name = user_info.first_name
video = "http://t.me/V_I_K_I_N_G_2/107"
local Name = 'بوت تواصل سورس فايكينج '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text =first_name, url = "https://t.me/V_I_K_I_N_G_1"}
...
{
{text = '𓄼•ʙᴏᴛ•𓄹',url="t.me/AsaliyaEgypt_bot"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
local first_name = user_info.first_name
video = "http://t.me/V_I_K_I_N_G_2/107"
local Name = 'قناه سورس فايكينج ياحب'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text =first_name, url = "https://t.me/V_I_K_I_N_G_1"}
...
{
{text = '𓄼•ᴄʜᴀɴɴᴇʟ•𓄹',url="t.me/V_I_K_I_N_G_1"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'فايكينج' or text == 'تيم فايكينج' or text == 'تيم' or text == 'التيم' then
photo = "https://t.me/V_I_K_I_N_G_2/9"
local Name = '𓄼•᭙ ꫀꪶ ᥴ ꪮ ꪑ ꫀ 𝓽 ꪮ 𝘴 ꪮꪊ𝘳 ᥴ ꫀ  ꪜ𝓲𝘬𝓲 ꪀ ᧁ•𓄹'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼•صـاحـب الـتـيـم•𓄹', url = "https://t.me/AsaliyaEgypt"}
},
{
{text = '𓄼•بـوت الـتـيـم•𓄹', url = "https://t.me/AsaliyaEgypt_bot"}
},
{
{text = '𓄼•جـروب التـيـم•𓄹', url = "https://t.me/TEAMSaidi1"},{text = '𓄼•قـنـاه الـتـيـم•𓄹', url = "https://t.me/rmdan_karim"}
},
{
{text = 'تيم فايكينج يورحي', url = "https://t.me/TEAMSaidi1"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '𓄼•𝘴ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ•𓄹 ', url = 't.me/omar_goo_noor'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "فايكينج")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/CH_Saidi'}, 
},
{
{text =first_name, url = "https://t.me/V_I_K_I_N_G_1"}
},
...
if text == (Redis:get(Saidi.."Saidi:Name:Bot") or "فايكينج") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local UserInfo = LuaTele.getUser(Saidi)
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
...
local CmdStart = '*\n 🤖 ╔•ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ  ʙᴏᴛ '..(Redis:get(Saidi.."Saidi:Name:Bot") or "فايكينج")..
...
keyboard.inline_keyboard = {
{
{text = '𓄼•عـسـكري•𓄹', url = "https://t.me/Ahmeaaa11"},{text = '𓄼•سـيـزر•𓄹', url = "https://t.me/ttccss"}
},
{
{text = '𓄼•عـسـلـيـه•𓄹', url = "https://t.me/AsaliyaEgypt"}
},
{
{text = '𓄼•عـايز سـورس•𓄹', url = "https://t.me/AsaliyaEgypt"}
},
{
...
data = {
{
{text = '𓄼•تـيـمـو•𓄹', url = "https://t.me/Ahmeaaa11"},{text = '𓄼•سـيـزر•𓄹', url = "https://t.me/ttccss"}
},
{
{text = '𓄼•عـايز سـورس•𓄹', url = "https://t.me/AsaliyaEgypt"}
},
...
data = {
{
{text = '𓄼 مطور السورس 𓄹',type = 'text'},{text = '𓄼 المبرمج سيزر 𓄹',type = 'text'}
},
{
...
local TestText = "  ❲ 𓄼•ᴅᴇᴠ•𓄹 ❳\n༺┉┉┉⊶﴾𓄼•𝘴ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ•𓄹﴿⊷┉┉┉༻n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id.."&parse_mode=markdown")
end
end
...
{
{text = '𓄼•جـروب التـيـم•𓄹', url = "https://t.me/TEAMSaidi1"},{text = '𓄼•قـنـاه الـتـيـم•𓄹', url = "https://t.me/V_I_K_I_N_G_1"}
},
{
{text = '𓄼•™ʽ𝙏𝙀𝘼𝙈❲𝙏•𝙑❳𝙑𝙄𝙆𝙄𝙉𝙂ʼ•𓄹', url = "https://t.me/TEAMSaidi1"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/V_I_K_I_N_G_1'}, 
},
{
{text =first_name, url = "https://t.me/V_I_K_I_N_G_1"}
},
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس فايكينج اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس فايكينج 
...
Redis:set(Saidi.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*⌯ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(Saidi.."zhrfa"..IdUser,"sendzh") 
