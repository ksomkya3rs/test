...
elseif tonumber(msg.sender.user_id) == 1438894020 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1438894020 then
msg.Name_Controller = 'مطور السـورس '
msg.The_Controller = 1
...
LuaTele.sendText(msg_chat_id,msg_id,'*🎌عدد احصائيات البوت الكامله \n— — — — — — — — —\n🎌عدد المجموعات : '..(Redis:scard(TheSaidi..'Saidi:ChekBotAdd') or 0)..'\n🎌عدد المشتركين : '..(Redis:scard(TheSaidi..'Saidi:Num:User:Pv') or 0)..'*',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'🎌عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheSaidi..'Saidi:Num:Add:Bot'),"md",true)  
end
...
'\n🎌معرفك : '..UserInfousername..
'\n🎌رتبتك : '..RinkBot..
'\n🎌رتبته بالكروب : '..StatusMemberChat..
'\n🎌رسائلك : '..TotalMsg..
'\n🎌تعديلاتك : '..TotalEdit..
'\n🎌تفاعلك : '..TotalMsgT..
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*🎌تم تنزيل الشخص من الرتب التاليه { "..dev..""..crrr..""..crr..""..cr..""..own..""..mod..""..vip.." *}","md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,'🎌عدد رسائلك هنا *~ '..(Redis:get(TheSaidi..'Saidi:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'🎌عدد التعديلات هنا *~ '..(Redis:get(TheSaidi..'Saidi:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'🎌عدد جهاتك المضافه هنا *~ '..(Redis:get(TheSaidi.."Saidi:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
🎌{ م3 }  ←  اوامـر المـدراء
🎌{ م4 }  ←  اوامـر المنشئـين
🎌{ م5 }  ←  اوامـر مطـورين البـوت
🎌{ م6 }  ←  اوامـر الخدمـات الالعـاب
🎌{ م7 }  ←  اوامـر القفـل & الفتـح
🎌{ م8 }  ←  اوامـر التعطيل & التفعيل
...
if text == (Redis:get(TheSaidi.."Saidi:Name:Bot") or "ميلان") then
local NamesBot = (Redis:get(TheSaidi.."Saidi:Name:Bot") or "ميلان")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات ميلان بعدين اجاوبك",
...
local CmdStart = '*\n🎌أهلآ بك في بوت '..(Redis:get(TheSaidi.."Saidi:Name:Bot") or "ميلان")..
...
🎌استوريات مقاطع انمي 🎎 » استوري
🎌عـروض الافـلام 🎞 » فلم
🎌اغـاني قصيـرة 🎶 » غنيلي
🎌صـور انمي عشوائي 🌁 » انمي
🎌صور ولـد انمي 🧝🏻 » انمي ولد
🎌صـور بنـات انمي 🧝🏻‍♀ » انمي بنت
🎌صـور عشوائـي 🎇 » صوره
🎌متحـركـات عشوائـي 🎆 » متحركه
🎌افتـارات بنـات تمبلـر 🧚‍♀ » افتار بنت
🎌افتـارات بنات رماديه 🙋🏻‍♀ » رمادي بنت
🎌افتـارات ولـد رمـاديه 🙋🏻‍♂ » رمادي ولد
🎌افتـارات بيست بنـات 👯‍♀ » بيست بنت
🎌افتـارات تطقيم حـب ❤️‍🔥 » تطقيم حب
ٴ┉┉┉┉┉┉┉┉┉┉┉ٴ
🎌قائمـة العـاب البـوت 🎮
ٴ┉┉┉┉┉┉┉┉┉┉┉ٴ
